...
?>
    ...
    $JFooter_Left = new Typecho_Widget_Helper_Form_Element_Textarea(
        'JFooter_Left',
        NULL,
        '2022 © Reach - <a href="https://blog.lmsite.eu.org" target="_blank" rel="noopener noreferrer">Joe</a>',
        '自定义底部栏左侧内容（非必填）',
        '介绍：用于修改全站底部左侧内容（wap端上方） <br>
         例如：2022 - 2023 © Reach - Joe Theme       '
    );
    ...
    $JFooter_Right = new Typecho_Widget_Helper_Form_Element_Textarea(
        'JFooter_Right',
        NULL,
        '<a href="https://blog.lmsite.eu.org/feed/" target="_blank" rel="noopener noreferrer">RSS</a>
         <a href="https://blog.lmsite.eu.org/sitemap.xml" target="_blank" rel="noopener noreferrer" style="margin-left: 15px">MAP</a>',
        '自定义底部栏右侧内容（非必填）',
    ...
    $JCommentMail = new Typecho_Widget_Helper_Form_Element_Select(
        ...
        'off',
        '是否开启评论邮件通知',
        '介绍：开启后如有评论将会发送邮件通知 <br />
         注意：此项开启后需要您完整无误的填写位于“其他设置”中的邮箱设置'
    );
    $JCommentMail->setAttribute('class', 'joe_content joe_global');
